...
pkgdatadir = $(datadir)/thebluebeast
pkgincludedir = $(includedir)/thebluebeast
pkglibdir = $(libdir)/thebluebeast
pkglibexecdir = $(libexecdir)/thebluebeast
...
ACLOCAL = ${SHELL} /tmp/TheBlueBeast/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /tmp/TheBlueBeast/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /tmp/TheBlueBeast/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /tmp/TheBlueBeast/build-aux/missing automake-1.15
AWK = gawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = thebluebeast-cli
BITCOIN_DAEMON_NAME = thebluebeastd
BITCOIN_GUI_NAME = thebluebeast-qt
BITCOIN_TX_NAME = thebluebeast-tx
...
COPYRIGHT_HOLDERS_FINAL = The TheBlueBeast Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = TheBlueBeast Core
COPYRIGHT_YEAR = 2019
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /tmp/TheBlueBeast/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL = 
OTOOL64 = 
PACKAGE = thebluebeast
PACKAGE_BUGREPORT = https://github.com/thebluebeast-project/thebluebeast/issues
PACKAGE_NAME = TheBlueBeast Core
PACKAGE_STRING = TheBlueBeast Core 0.16.3
PACKAGE_TARNAME = thebluebeast
PACKAGE_URL = https://thebluebeast.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /tmp/TheBlueBeast
abs_srcdir = /tmp/TheBlueBeast
abs_top_builddir = /tmp/TheBlueBeast
abs_top_srcdir = /tmp/TheBlueBeast
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /tmp/TheBlueBeast/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/TheBlueBeast-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/TheBlueBeast-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/TheBlueBeast-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/TheBlueBeast-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)

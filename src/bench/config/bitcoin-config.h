...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The TheBlueBeast Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "TheBlueBeast Core"
...
#define PACKAGE_BUGREPORT "https://github.com/thebluebeast-project/thebluebeast/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "TheBlueBeast Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "TheBlueBeast Core 0.16.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "thebluebeast"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://thebluebeast.org/"

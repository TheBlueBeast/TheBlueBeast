...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s thebluebeast-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  thebluebeast-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded thebluebeast transaction") + "\n" +
              "  thebluebeast-tx [options] -create [commands]   " + _("Create hex-encoded thebluebeast transaction") + "\n" +
              "\n";
